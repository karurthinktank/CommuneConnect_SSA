...
SECRET_KEY = 'django-insecure-m1dj-#qp8^gt^1qzoiw!b_xtppptnyz&zac0o%lr&-k765h9rh'
...
CLOUDSQL_CONNECTION_NAME = "thinktank-tms-dev-env:asia-south1:tms-dev"
